...
setwd("C:\\Users\\YunGu\\Desktop\\TCGA")                    #Set the working directory
library("edgeR")
...
group=c(rep("normal",51),rep("tumor",45))                         #Modify according to the number of cancer and normal samples
